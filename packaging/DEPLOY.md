...
- 1.5.0 最终构建：CPU runtime 从空目录重建（`-Flavor cpu`，torch/torchaudio 2.7.1+cpu，DSP 脚本与 critical-manifest 校验通过），PyInstaller 外壳 + Inno Setup 编译通过。安装器 `ShadowBuster-Setup-1.5.0.exe` 大小 `796446223` bytes，SHA-256：`174046972c1a213db41516c3ca87458cec257735535665480ecbc304995ed4e1`。
