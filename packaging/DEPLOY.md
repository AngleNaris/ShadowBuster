...
- 1.5.0 最终构建：CPU runtime 从空目录重建（`-Flavor cpu`，torch/torchaudio 2.7.1+cpu，DSP 脚本与 critical-manifest 校验通过），PyInstaller 外壳 + Inno Setup 编译通过。安装器 `ShadowBuster-Setup-1.5.0.exe` 大小 `787889228` bytes，SHA-256：`e975b13e17d45e86ea3817b7ea736fa459bfe98da7cc38a00510a4ce8603c389`。
