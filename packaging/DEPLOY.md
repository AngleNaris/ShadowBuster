...
- 1.4.2 最终构建：runtime 从空目录重建（四份 DSP 脚本哈希一致、关键 manifest 覆盖），PyInstaller 外壳 + Inno Setup 6.7.3 编译通过。安装器 `ShadowBuster-Setup-1.4.2.exe` 大小 `2747579412` bytes，SHA-256：`367e74694df09971c433383a12882a1b63b427741f247ffb8c43b012b20210a9`。
